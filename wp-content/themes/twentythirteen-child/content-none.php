...
<header class="page-header">
	<h1 class="page-title"><?php _e( 'Alas, nothing found...', 'twentythirteen' ); ?></h1>
</header>
...
<div class="page-content">
	...
	<p><?php _e( 'We&rsquo;re sorry, but nothing matched your search terms. Please try again with different keywords.', 'twentythirteen' ); ?></p>
	<?php get_search_form(); ?>
